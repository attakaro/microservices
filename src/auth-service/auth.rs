...
impl Auth for AuthService {
    async fn sign_in(
        ...
        let result: Option<String> = 
            self.users_service.lock().expect("mutex lock poisoned error")
        ...
        let session_token: String = 
            self.sessions_service.lock().expect("mutex lock poisoned error")
    ...
    async fn sign_up(
        ...
        let result: Result<(), String> = 
            self.users_service.lock().expect("mutex lock poison error")
